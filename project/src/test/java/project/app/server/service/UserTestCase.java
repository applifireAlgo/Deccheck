...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("BYxS4C9JtvgjFwWzUYJD8IgXOnYYnyjKZ9wdY04k52Whm0Ki0a");
            useraccessdomain.setDomainHelp("uHs142zG3DgXgq01RWUuWfAYEXzAHStcBaKNAJzymiL85xrQ6M");
            useraccessdomain.setDomainIcon("90CFUrRj7ceNWaFH5EPWaz1kfGRsPKoViKjhAAWD6LNK58wKts");
            useraccessdomain.setDomainName("xuYaERmtNoqodNbf13YRvXfZ4N83J8x1IYthVSJBpsyBHfRXht");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("aK22NDyDE8t6ApL9NCCOIB77Y93XG7OcEGgS5cw4l5ew2mDmI6");
            useraccesslevel.setLevelHelp("KnMQUQowBzZAoMJbFeaa3jOfr1X1TUEelabPg46ZxTkwemfuZq");
            useraccesslevel.setLevelIcon("03kIkKXQct6s66cBP61Skg9KJWJNnJLj6ePmFctvlwsgIS3rN9");
            useraccesslevel.setLevelName("9nMy2nJSQZpqI5xm5TFCH4xqQDe3cutFVFEvweWLPWjCjiaHH2");
            ...
            user.setPasswordAlgo("TQ6F3G2v0qgxr9gdZKuTt7yZuvNyLv1QGAtuJSzBOlFwI4rS99");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(1218);
            user.setUserAccessCode(7);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("Dr9fp2wrt1oxm9kMtvHV8YUL2EEKw0VcrzggLNJF6N3A4tXd7J");
            Question question = new Question();
            question.setLevelid(0);
            question.setQuestion("l7FfxLUGfEEQGwaZRqCeHRsDOF0CLm5mviDKIKFjF1ye3t7P2k");
            question.setQuestionDetails("k");
            question.setQuestionIcon("bM5X28b1w5bw2XIXGaz48NRqwWQ93Nq2lcK8rLe5225eeQYGIG");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("ChEhxfsmO0tiygto8dY4ym1PHZBVG00KXhDcvzLOljmt7bbT12");
