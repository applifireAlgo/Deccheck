package sales.app.shared.authorization;
...
@SourceCodeAuthorClass(createdBy = "puja.singh@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            sales.app.shared.authorization.AppMenus other = (sales.app.shared.authorization.AppMenus) obj;
            if (menuId == null) {
                return false;
