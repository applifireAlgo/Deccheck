package sales.app.shared.authentication;
...
@SourceCodeAuthorClass(createdBy = "puja.singh@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Login", complexity = Complexity.LOW)
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            sales.app.shared.authentication.Login other = (sales.app.shared.authentication.Login) obj;
            if (loginPk == null) {
                return false;
