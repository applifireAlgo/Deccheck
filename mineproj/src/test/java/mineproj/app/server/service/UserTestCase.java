...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("2n6FPDLJU1RvPbmka0Qx3RhmTEHuTkFDtwio7VeXRhJ3bixXJE");
            useraccessdomain.setDomainHelp("JH4TK0bz1MuwZtt0RMkkEnSgDDt2R3GlZaileHy4OxlDvINyTY");
            useraccessdomain.setDomainIcon("Cljfc7Wsg72EzVNgoLMj4fFhi3wiblJ3ntWrCvsXmqScPpHfKv");
            useraccessdomain.setDomainName("6es3prb5kD4ZQeDinH9uJVzvofKnNsfSgOJdEVWKRd9IKUf8yP");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("njFxZxWrlYFlMxvBiClgDL9fMz3ctcIXnZPMkiSYAGGrhmjNpg");
            useraccesslevel.setLevelHelp("nmWFY5IFmXxKLp0GpF9GHx70eOeDk6RDgw9u140l34mOxB5Jb7");
            useraccesslevel.setLevelIcon("OoAoR9rQWR6W4o1irmAmtvEWxV7bSMixIUYyMxy2Ji3ZOEnUU6");
            useraccesslevel.setLevelName("8rCHzgkIzdGPzgaJpz1dEOY9G2zNA1eozG6EiQm3JHtqbK9c6O");
            ...
            user.setPasswordAlgo("dpxBhZkCZVfZnFs7KwLA6ESYDzIYY0tnc4DnTtT0vY9NZ2JJcw");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(2707);
            user.setUserAccessCode(1);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("cHO6ocOWQz9WMUD1OdfFrGav5jvGaRaxIZglq19Vx1fw3J3PMW");
            Question question = new Question();
            question.setLevelid(6);
            question.setQuestion("1JQTaMLpVTPb6n0vX2ReaShRM1Y3pzdy7LABSOPAF6hN2btmFl");
            question.setQuestionDetails("Mt6");
            question.setQuestionIcon("XirIrU58gdeTfouAV79X9Af6FWS9W71rb3yABODWEvVpqArgDl");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("o74ekmsM9mRO7nuMBSH7hAK2aAjy3vpjvLbzlA5ks3lNsbWty8");
